...
server.tool(
  '',
  'Fetch all open CFPs from  for the authenticated speaker account. Returns array of events with CFP dates, location, expenses, isOnline, cfpLink. Host handles the API key ().',
  {
    filter: z
      .object({
        isOnline: z
