...
export function buildVolumeMounts(
  ...
  // branching here, or merge in any user-editable input, the file stops
  // being pure-generated and needs to move to the shared-memory mount
  // alongside auto-memory.
